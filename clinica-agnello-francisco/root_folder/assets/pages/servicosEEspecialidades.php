...
include '../../adimin/config/database.php';
session_start();
...
<head>
    ...
    <link rel="stylesheet" href="../../../assets/css/servicosEEspecialidades.css" />
</head>
...
<body>
    ...
    <header class="cabecalho">
        ...
        <nav>
            ...
            <a class="borda" href="servicosEEspecialidades.php">SERVIÇOS-E-ESPECIALIDADES</a>
            <button class="atendimento" onclick="window.location.href='../../admin/service/atendimento.php'">ATENDIMENTO</button>
            <button class="logout" onclick="window.location.href='../../admin/config/logout.php'">LOGOUT</button>
        </nav>
    </header>

    <main class="conteudo">
        <section class="principal">
            <img src="../../../assets/img/amigos.png" alt="amigos">
        ...
        <section class="quintenario">
                <img src="../../../assets/img/cachorro&gatos.png" alt="cachorro&gatos">
        </section>
    </main>
