...
<body>
    ...
    <header class="cabecalho">
        ...
        <nav>
            ...
            <a class="borda" href="sobreNos.php">SOBRE-NÓS</a>
            <a href="servicosEEspecialidades.php">SERVIÇOS-E-ESPECIALIDADES</a>
    ...
    <main class="conteudo">
      <section class="principal">
        <img src="../../../assets/img/equipe.png" alt="1" />
        <h2>QUEM-SOMOS</h2>
        <p>
      ...
      <section class="secundario">
        ...
        <section class="cards">
          <div class="card">
            <img src="../../../assets/img/veterinario1.png" alt="2" />
            <div>
              <h3>Dr. João Silva</h3>
          ...
          <div class="card">
            <img src="../../../assets/img/veterinario2.png" alt="3" />
            <div>
